...
async def start(client, message: pyrogram.types.Message):
    ...
    if message.chat.type in ['group', 'supergroup']:
        buttons = [[
        InlineKeyboardButton("◽ Channel", url=f'https://t.me/at3_movies'),
        InlineKeyboardButton("Group ◽", url =f'https://t.me/at3movies')
    ]]
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        ...
        buttons = [[
        InlineKeyboardButton("◽ Channel", url=f'https://t.me/at3_movies'),
        InlineKeyboardButton("Group ◽", url =f'https://t.me/at3_movies')
    ]]
